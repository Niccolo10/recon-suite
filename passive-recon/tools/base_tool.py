...
class BaseTool(ABC):
    ...
    def run(self, domains: List[str]) -> List[Tuple[str, Dict]]:
        ...
        Returns:
            ...
            Example: [('api.example.com', {'tags': 'production'}), ...]
        """
        pass
    
    def save_temp_output(self, data: str, filename: str):
        """
        Save raw output to temp directory for debugging/checkpointing
        
        Args:
            data: Raw output data to save
    ...
    def get_timeout(self) -> int:
        """Get tool timeout from config or default"""
